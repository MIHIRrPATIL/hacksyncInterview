...
4. Include MULTIPLE topics to learn (at least 5-7 topics)
5. Include MULTIPLE course recommendations (at least 4-6 courses)
6. Provide DETAILED practice recommendations with specific daily/weekly goals
...
JSON FORMAT:
{
  ...
  "topicsToLearn": [
    ...
    // Include 5-7 topics covering: algorithms, data structures, system design, coding patterns, communication, etc.
  ],
  "recommendedCourses": [
    {
    ...
    // Include 4-6 courses covering different skill gaps
  ],
  "practiceRecommendations": [
    ...
    // Include 5-6 practice recommendations
  ],
  "nextSteps": [
