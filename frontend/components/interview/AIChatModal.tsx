...
export default function AIChatModal({ isOpen, onClose, currentCode, problem }: AIChatModalProps) {
  const [messages, setMessages] = useState<Message[]>([
    { role: 'assistant', content: "Hi! I'm your SkillSphere AI assistant. I've analyzed the problem and your current progress. How can I help you? I can provide hints or explain concepts without giving away the full solution." }
  ]);
      ...
      const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: `You are an elite coding interview assistant on the SkillSphere platform. 
        ...
        <div className="p-6 border-b border-gray-100/10 flex items-center justify-between">
           <div className="flex items-center gap-3">
              ...
              <div>
                 ...
                 <p className="text-[10px] uppercase font-black tracking-widest text-orange-500">MiMo Powered</p>
              </div>
           </div>
